...
{
    static GZYAppContext *sharedInstance;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedInstance = [[GZYAppContext alloc] init];
...
- (void)configWithChannelID:(NSString *)channelID appName:(NSString *)appName appType:(NSInteger)appType ccid:(NSString *)ccid
{
